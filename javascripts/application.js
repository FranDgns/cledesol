	...
	$.ajax("https://plateforme.api-agro.fr/api/records/1.0/search/?dataset=parcelles-vigicultures-sols&geofilter.distance=" + lat + "," + lng + "," + radius + "&fields=type_sol&apikey=7c7295c3ffbfce70ec53daa132c3a2825e3aa8ca439f27b33e342d20", {
		success: function (data, status, request) {
			if (data.nhits > 0) {
				...
				// series1 = data
				$.ajax("https://plateforme.api-agro.fr/api/records/1.0/analyze/?dataset=parcelles-vigicultures-sols&geofilter.distance=" + lat + "," + lng + "," + radius + "&fields=type_sol&apikey=7c7295c3ffbfce70ec53daa132c3a2825e3aa8ca439f27b33e342d20" + "&x=type_sol&y.count.func=COUNT", { // remplacer type_sol avec "Nom officiel"
					success: function (data, status, request) {
						console.log(data);
						...
						Cledesol.showDonutValidation(tableauCount, tableauLabel); // appeller des choses definies apres
					}
				});
			} else {
